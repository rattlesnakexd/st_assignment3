...
public class DB_Filing implements DBduties {
    ...
    public void Load() throws FileNotFoundException {
        ...
        Gson gson = new Gson();
        try (FileWriter writer = new FileWriter("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\output1.json")) {
            gson.toJson(info, writer);
        } catch (IOException e) {
            e.printStackTrace();
        }
        try (FileWriter writer = new FileWriter("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\output2.json")) {
