...
public class MainMenu extends Application {
    ...
    public MainMenu() {
        ...
        if (count == 0) {
            Gson gson = new Gson();
            try (Reader reader = new FileReader("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\DH.json")) {
                datafuncs = gson.fromJson(reader, DataHandler.class);
                reader.close();
                Helper.deleteFile("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\DH.json");
            } catch (IOException e) {
                e.printStackTrace();
            }
            try (Reader reader = new FileReader("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\BL.json")) {
                gameFuncs = gson.fromJson(reader, GameLogic.class);
                reader.close();
                Helper.deleteFile("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\BL.json");
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
