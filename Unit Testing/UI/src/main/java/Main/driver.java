...
public class driver {
    ...
    public static void main(String[] args) throws SQLException, FileNotFoundException, InterruptedException, ClassNotFoundException {
        ...
        Gson gson = new Gson();
        try (FileWriter writer = new FileWriter("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\DH.json")) {
...
//        try (FileWriter writer = new FileWriter("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\DB.json")) {
...
//        }
        GameLogic BL;
        BL = new GameLogic(dt);
        try (FileWriter writer = new FileWriter("C:\\Users\\abdul\\Documents\\GitHub\\GameOfLife\\AllModules\\DataExchange\\BL.json")) {
